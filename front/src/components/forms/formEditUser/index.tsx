...
const FormEditUser = ({
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <form
        noValidate
        className="flex flex-col gap-5 overflow-y-scroll scrollbar scrollbar-w-2 scrollbar-track-rounded-md scrollbar-track-brand-3 scrollbar-thumb-rounded-md scrollbar-thumb-brand-1 h-[550px] lg:h-[600px] pr-2"
